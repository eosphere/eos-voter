...
function getActiveBlockProducers() {
    return [
             {'id': '3b887c39-e497-4984-8ce1-5f01abec8c95', 'name': 'Simon', 'votes': '1,000,000', 'statement': 'Blah Blah'},
             {'id': '063d27bb-ec73-4baf-9f08-1918d5405a01', 'name': 'Peter', 'votes': '990,000', 'statement': 'Yellow'},
        ...
        return m("main", [
                 ...
                 m("div", {'class': 'content-container'}, [
                   ...
                   m('div', {'class': 'block-producer-list'}, [
                     ...
                     ].concat(getActiveBlockProducers().map((block_producer) => {
